...
var config = {
  apiOrigins: {
    production: 'https://protected-ridge-59730.herokuapp.com'
  }
};
...
var getFormFields = __webpack_require__(15);
...
var onChangePassword = function onChangePassword(event) {
  ...
  api.changePassword(data).then(ui.changeSuccess).catch(ui.changeFailure);
};
...
var onCreateSurvey = function onCreateSurvey(event) {
  event.preventDefault();
  var data = getFormFields(event.target);

  api.createSurvey(data).then(ui.createSuccessful).catch(ui.createFailed);
};

var onShowAllSurveys = function onShowAllSurveys(event) {
  event.preventDefault();
  api.showAllSurveys().then(ui.showAllSuccess).catch(ui.showAllFailure);
};

var onShowOneSurvey = function onShowOneSurvey(event) {
  event.preventDefault();
  dataId = $(event.target).attr('data-id');
  api.showOneSurvey(dataId).then(ui.showOneSuccess).catch(ui.showOneFailure);
};

var onUpdateSurvey = function onUpdateSurvey(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateSurvey(data).then(ui.updateSuccess).catch(ui.updateFailed);
};
...
var onDeleteSurvey = function onDeleteSurvey(event) {
  ...
  var data = getFormFields(event.target);
  api.deleteSurvey(data).then(ui.deleteSuccess).catch(ui.deleteFailed);
};
...
var onCreateResponse = function onCreateResponse(event) {
  ...
  api.createResponse(selection, dataId).then(ui.createResponseSuccessful);
...
var addHandlers = function addHandlers() {
  ...
  $('#showOptionOne').on('click', function () {
    selection = 0;
  });
  $('#showOptionTwo').on('click', function () {
    selection = 1;
  });
...
var showAllSurveys = function showAllSurveys() {
  return $.ajax({
    url: config.apiOrigin + '/surveys',
    method: 'GET',
    headers: {
...
var showOneSurvey = function showOneSurvey(id) {
  return $.ajax({
...
var updateSurvey = function updateSurvey(data) {
  return $.ajax({
...
var deleteSurvey = function deleteSurvey(data) {
  return $.ajax({
    url: config.apiOrigin + '/surveys/' + data.survey.id,
    method: 'DELETE',
    headers: {
...
var createResponse = function createResponse(selected, id) {
  return $.ajax({
...
var store = __webpack_require__(5);
var showSurveysTemplate = __webpack_require__(18);
...
var changeSuccess = function changeSuccess() {
...
var changeFailure = function changeFailure() {
...
var showAllSuccess = function showAllSuccess(data) {
  var showSurveysHTML = showSurveysTemplate({ surveys: data.surveys });
...
var showOneSuccess = function showOneSuccess(data) {
  store.survey = data.survey;
  $('#showOptionOne').html(store.survey.optionOne);
  $('#showOptionTwo').html(store.survey.optionTwo);

  zeros = store.survey.responses.filter(function (x) {
    return x === 0;
  });

  ones = store.survey.responses.filter(function (x) {
    return x === 1;
  });
...
var createSuccessful = function createSuccessful(data) {
...
var createFailed = function createFailed(data) {
...
var deleteFailed = function deleteFailed() {
...
var createResponseSuccessful = function createResponseSuccessful() {
  $('#vote').modal('hide');
...
module.exports = {
  ...
  showOneSuccess: showOneSuccess,
  updateSuccess: updateSuccess,
  updateFailed: updateFailed,
  deleteSuccess: deleteSuccess,
  deleteFailed: deleteFailed,
  createResponseSuccessful: createResponseSuccessful
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n  <div data-id=\""
    ...
    + "\">\n    <div class=\"col-xs-12 col-sm-4 col-md-4 col-lg-3 spaced\">\n      <p> Which do you prefer? "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.optionOne : stack1), depth0))
    + " or "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.optionTwo : stack1), depth0))
    + "?</p>\n      <p>This survey's id is "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + " <br> Copy this id and use it to update or delete this survey.\n        You can only update or delete a survey that you created</p>\n\n\n      <a data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " id=\"voteNowButton\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#vote\" data-original-title>Vote Now!</a>\n    </div>\n\n";
...
/* WEBPACK VAR INJECTION */(function(jQuery) {// jQuery toast plugin created by Kamran Ahmed copyright MIT license 2015
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./jquery.toast.css", function() {
			var newContent = require("!!../../css-loader/index.js!./jquery.toast.css");
